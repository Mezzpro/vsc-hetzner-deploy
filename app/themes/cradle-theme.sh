...
cat > /home/coder/workspace-admin/.vscode/settings.json <<'EOF'
{
  ...
  "timeline.excludeSources": ["git-history", "timeline-source", "extension-timeline"],
  "workbench.panel.visible": false,
  "terminal.integrated.showOnStartup": "never",
  "workbench.view.search.visible": false,
  ...
  "terminal.integrated.showExitAlert": false,
  "window.title": "CradleSystem - ${activeEditorShort}",
  "workbench.auxiliaryBar.visible": true,
  "workbench.auxiliaryBar.location": "right", 
  "terminal.integrated.defaultLocation": "view",
  "terminal.integrated.tabs.location": "view",
  "workbench.view.terminal.location": "terminal",
